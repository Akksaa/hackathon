...
//     <div className="flex justify-center py-10 px-4">
    //   <div className="bg-white sm:p-8 w-full max-w-5xl">
    ...
    //         <button
    //           type="button"
    //           className=" text-gray-700 border-gray-700 border-[1px] px-6 py-2"
    //         >
    //           Back to cart
    //         </button>
    //         <button
...
//             </div>
//           </div>
//           <button className="mt-6 bg-primYellow text-white px-6 py-2 rounded-md shadow hover:bg-orange-600 w-full">
//             Place an order
//           </button>
//         </div>
//       </div>
